...
var inlineResources = require('./tools/gulp/inline-resources');
...
gulp.task('build:themes', function () {
  return gulp.src(`${tmpFolder}/styles/themes/**/*.scss`)
    .pipe(sass().on('error', sass.logError))
    .pipe(gulp.dest(`${distFolder}/themes`));
});
...
gulp.task('rollup:umd', function () {
  ...
  // transform the files here.
    ...
    .pipe(rename('ic-datepicker.umd.js'))
    .pipe(gulp.dest(distFolder));
});
...
/**
 * 10. Replace the moment import syntax. The former is required for the build, but the latter for use in the consuming
 *     application
 */
